  ...
  return (
    <>
      ...
      <div className="prose prose-sm text-[#374151] leading-7 space-y-4 max-w-2xl">
        ...
        <p>
          For shipments to the United Kingdom, and to any other country outside the EU/EEA, any customs duties, import VAT, or handling fees charged on arrival are the buyer&apos;s own responsibility and are not included in our shipping charge.
        </p>
        <p>
